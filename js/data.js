function getData () {
    let data = [
        ...
        },
        {
            ...
            "theme": "JavaScript",
            "result": [
                [20, "есть задатки, нужно развивать"],
                [60, "очень хорошо, но есть пробелы"],
                [90, "отличный результат"]
            ],
            "list": [
                ...
                {
                    "type": "radio",
                    "question": "Этот метод разбивает строку на подстроки в виде массива строк",
                    "answers": ["split()", "slice()", "charAt()", "splice()"]
                },
                {
                    "type": "radio",
        ...
        },
        {
            ...
            "theme": "HTML",
            "result": [
                [10, "есть задатки, нужно развивать"],
                [60, "очень хорошо, но есть пробелы"],
                [90, "отличный результат"]
            ],
            "list": [
                ...
                {
                    "type": "radio",
                    "question": "Сколько атрибутов id с одинаковым значением может быть на странице",
                    "answers": ["Один", "Два", "Сколько угодно", "Ни одного, нет такого атрибута"]
                },
                {
                    "type": "checkbox",
